        ...
        <div id="dashboard" class="dashboard-container">
            <div class="dashboard-header sticky-header">
                <div class="content-left  logo-section pull-left">
                    <h1><a href="{{ url('/') }}"><img src="{{ asset('assets2/images/logo.png') }}" alt=""></a></h1>
                </div>
            ...
            <div class="dashboard-navigation">
                ...
                <div id="navigation" class="navigation-container">
                    <ul>
                        <li class="active-menu"><a href=""><i class="far fa-chart-bar"></i> Dashboard</a></li>
                        ...
                        <li><a href=""><i class="fas fa-umbrella-beach"></i>Add Package</a></li>
                        <li>
                        ...
                        <li><a href=""><i class="fas fa-ticket-alt"></i> Booking & Enquiry</a></li>

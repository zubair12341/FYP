 ...
 <section class="about-section about-page-section">
    <div class="about-service-wrap">
       <div class="container">
          ...
          <div class="about-video-wrap" style="background-image: url({{ asset('assets/images/img25.jpg') }});">
    ...
    <div class="client-section">
       <div class="container">
          ...
          <div class="client-wrap client-slider">
             ...
             <div class="client-item">
                <figure>
                   <img src="{{ asset('assets/images/logo9.png') }}" alt="">
                </figure>
             </div>
             <div class="client-item">
                <figure>
                   <img src="{{ asset('assets/images/logo10.png') }}" alt="">
                </figure>
             </div>
             <div class="client-item">
                <figure>
                   <img src="{{ asset('assets/images/logo11.png') }}" alt="">
                </figure>
             </div>
             <div class="client-item">
                <figure>
    ...
    <div class="fullwidth-callback" style="background-image: url({{ asset('assets/images/img26.jpg') }});">
       <div class="container">
